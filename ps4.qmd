...
filtered_zips['category'] = 'Not Affected' 
filtered_zips.loc[filtered_zips['zip_code'].isin(closures_df['zip_code']), 'category'] = 'Directly Affected'
filtered_zips.loc[indirectly_affected['index_right'].notna(), 'category'] = 'Indirectly Affected'

color_map = {'Directly Affected': 'red', 'Indirectly Affected': 'orange', 'Not Affected': 'lightgrey'}

fig, ax = plt.subplots(1, 1, figsize=(10, 8))
filtered_zips.plot(column='category', color=filtered_zips['category'].map(color_map), legend=True, ax=ax)
