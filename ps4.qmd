...
plt.show()
#Citation: ChatGPT query of: how to make choropleth from zip code level data. The query returned the steps from line 721 to 730. Syntax for choropleth found on Stack Overflow thread for the same query.
